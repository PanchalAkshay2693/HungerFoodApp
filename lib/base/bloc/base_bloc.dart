...
class BasePageBloc extends BaseBloc {
  ...
  BehaviorSubject<int> get placeHolderStatusStream => placeHolderStatus.stream as BehaviorSubject<int>;

  late BehaviorSubject<bool> isKeyboardVisible;
  BehaviorSubject<bool> get isKeyboardVisibleStream => isKeyboardVisible.stream as BehaviorSubject<bool>;
