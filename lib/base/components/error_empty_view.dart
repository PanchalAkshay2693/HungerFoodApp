import 'package:drc_tea_canteen/base/components/screen_utils/flutter_screenutil.dart';
import 'package:drc_tea_canteen/base/src_widgets.dart';
...
class QuickView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final r = onRetry == null
        ? Container()
        : ButtonView("Retry", onPressed: onRetry,color: ACCENT_COLOR,);
